...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('template/assets/images/icon/favicon.ico')}}">
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('asset/logo.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="/data-siswa"><i class="ti-dashboard"></i><span>Data Kelas</span></a></li>
                            <li>
                            ...
                            <li><a href="/data-siswa"><i class="ti-dashboard"></i><span>Logout</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('template/assets/images/author/author-img1.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('template/assets/images/author/author-img2.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('template/assets/images/author/author-img3.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('template/assets/images/author/author-img4.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
    ...
    <script src="{{ asset('template/assets/js/line-chart.js')}}"></script>
    <!-- all pie chart -->
    <script src="{{ asset('template/assets/js/pie-chart.js')}}"></script>
    <!-- others plugins -->
